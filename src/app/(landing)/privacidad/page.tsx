      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="prose prose-lg text-gray-600 space-y-8">
          <div>
            ...
            <p>
              En SisRRHH, nos comprometemos a proteger tu privacidad. Esta Política de Privacidad explica cómo recopilamos, 
              utilizamos, divulgamos y salvaguardamos tu información.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 mt-4">
              ...
              <li>Enviar actualizaciones, alertas y notificaciones</li>
              <li>Cumplir con obligaciones legales</li>
              <li>Proteger contra fraude y garantizar seguridad</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              acceso no autorizado. Esto incluye encriptación, autenticación de dos factores y auditorías regulares.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              No vendemos tu información personal. Solo compartimos información con terceros cuando:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4">
              <li>Es necesario para prestar nuestros servicios</li>
          ...
          <div>
            ...
            <p>
              Tienes derecho a acceder, rectificar o eliminar tus datos personales. Contáctanos en 
              <a href="mailto:privacidad@sisrrhh.pe" className="text-blue-600 hover:text-blue-700 ml-1">
                privacidad@sisrrhh.pe
              </a>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4">
              <a href="mailto:privacidad@sisrrhh.pe" className="text-blue-600 hover:text-blue-700">
                privacidad@sisrrhh.pe
              </a>
            </p>
          </div>
