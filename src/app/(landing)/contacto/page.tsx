      ...
      <section className="py-12 lg:py-16 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Ponte en Contacto</h1>
            <p className="text-xl text-gray-600">¿Preguntas sobre SisRRHH? Estamos aquí para ayudarte.</p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="mailto:ventas@sisrrhh.pe" className="text-blue-600 hover:text-blue-700">
                      ventas@sisrrhh.pe
                    </a>
                  </p>
                  <p className="text-gray-600">
                    <a href="mailto:soporte@sisrrhh.pe" className="text-blue-600 hover:text-blue-700">
                      soporte@sisrrhh.pe
                    </a>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="tel:+51123456789" className="text-blue-600 hover:text-blue-700">
                      +51 (1) 2345-6789
                    </a>
                  </p>
                </div>
