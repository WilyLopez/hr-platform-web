...
export default function LandingPage() {
  ...
  const plans = planesData?.slice(0, 2).map((plan: Plan, index: number) => ({
    name: plan.nombre === "PRO" ? "Pro" : "Básico",
    price: `S/ ${plan.precio_mensual.toFixed(2)}`,
    features: [
